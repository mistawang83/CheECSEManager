...
import ca.mcgill.ecse.cheecsemanager.fxml.controller.purchase.PurchaseDisplayManyController;
import ca.mcgill.ecse.cheecsemanager.fxml.controller.purchase.PurchaseDisplayOneController;
...
public class OrderDisplayController extends BaseDisplayController implements Initializable {
  ...
  protected Pane getChildContainer() {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        super.loadFXML("view/page/order/OrderDisplayMany.fxml");
    }
